...
const rEmail =
  /^([a-zA-Z0-9._-]+)([@]{1})([a-zA-Z0-9-])+.([a-z]{2,10})(.[a-z]{2,8})$/;
  ...
  function submitHandler(e) {
    ...
    if (!rPass.test(formValues.password)) {
      ...
      ErrorObj.passwordError =
        "*Must contain 1 uppercase,lowercase, special charcter";
      setFormErrors(ErrorObj);
    ...
    if (verified === false) ErrorObj.captchaError = "* Captcha not verified";
    ...
    if (returnVal && verified) {
      ...
      const dataCheck = {
        ...
        rollNum: formValues.rollNum.toString(),
    ...
    //  Removed comments
      ...
      axios
        .post(`${process.env.REACT_APP_REGISTER}`, dataCheck)
    ...
    <div className="wrap--Box">
      <div className="wrap--form">
        ...
        <form className="form signupForm" onSubmit={submitHandler}>
          ...
          <span className="errorText bigText">
            {errorSubmit ? "*Error occured in submitting the form" : ""}
          </span>
          <div className="grid grid--col2 ">
            ...
            <span className="wrap--regnInput">
              ...
              <select
                ...
                onChange={handleChange}
              >
                <option className="year" value="">
                  --Please select--
                </option>
                <option className="year" value="1">
                  First Year
                </option>
                <option className="year" value="2">
                  Second Year
                </option>
                <option className="year" value="3">
                  Third Year
                </option>
                <option className="year" value="4">
                  Fourth Year
                </option>
              </select>
            ...
            <span className="wrap--regnInput">
              ...
              <select
                ...
                onChange={handleChange}
              >
                <option className="branch" value="">
                  --Please select--
                </option>
                <option className="branch" value="CSE">
                  CSE
                </option>
                <option className="branch" value="CSE-AIML">
                  CSE-AIML
                </option>
                <option className="branch" value="CSE-DS">
                  CSE-DS
                </option>
                <option className="branch" value="IT">
                  IT
                </option>
                <option className="branch" value="CS">
                  CS
                </option>
                <option className="branch" value="AIML">
                  AIML
                </option>
              </select>
          ...
          <span>
            ...
            <NavLink to="/" onClick={delRegisterKeyFunction}>
              Sign in
            </NavLink>
          </span>
        </form>
